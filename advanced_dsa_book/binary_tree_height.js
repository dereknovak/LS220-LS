...
Definition: The maxiumum height of the binary tree is 1 greater than the maximum height of its left and right subtrees
*/

function getHeight(treeRoot) {
  function maxHeight(currentNode) {
    if (!currentNode) return 0;
    return Math.max(maxHeight(currentNode.left), maxHeight(currentNode.right)) + 1;
  }
