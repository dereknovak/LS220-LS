/* 
- YOLOd this and got it right on the first try
- Took about 15 minutes
- My solution is ugly compared to provided one, but I did not use hints and it worked
...
function getHeight(root) {
  function traverse(node, distance = 1) {
    if (!node) return;
